...
(new stdgo._internal.testing.Testing.InternalTest(("TestSourcePosNewline" : stdgo.GoString), stdgo._internal.go.printer.Printer.testSourcePosNewline) : stdgo._internal.testing.Testing.InternalTest)].concat([for (i in 17 ... (17 > 17 ? 17 : 17 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.testing.Testing.InternalTest)])) : stdgo.Slice<stdgo._internal.testing.Testing.InternalTest>);
var _benchmarks : stdgo.Slice<stdgo._internal.testing.Testing.InternalBenchmark> = (new stdgo.Slice<stdgo._internal.testing.Testing.InternalBenchmark>(2, 2, ...[(new stdgo._internal.testing.Testing.InternalBenchmark(("BenchmarkPrintFile" : stdgo.GoString), stdgo._internal.go.printer.Printer.benchmarkPrintFile) : stdgo._internal.testing.Testing.InternalBenchmark), (new stdgo._internal.testing.Testing.InternalBenchmark(("BenchmarkPrintDecl" : stdgo.GoString), stdgo._internal.go.printer.Printer.benchmarkPrintDecl) : stdgo._internal.testing.Testing.InternalBenchmark)].concat([for (i in 2 ... (2 > 2 ? 2 : 2 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.testing.Testing.InternalBenchmark)])) : stdgo.Slice<stdgo._internal.testing.Testing.InternalBenchmark>);
